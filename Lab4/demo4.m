...
endwhile
printf("Mean number of clients is: %f\n", mean_clients)
printf("Ergodic Probability P(0) = %f%%\n",100 * P(1))
printf("Ergodic Probability P(1) = %f%%\n", 100 * P(2))
printf("Ergodic Probability P(2) = %f%%\n", 100 * P(3))
printf("Ergodic Probability P(3)/Rejection = %f%%\n", 100 * P(4))
